...
head-rev-role-greeting =
    ...
    Синдикат проспонсировал вас технологией вербовки людей при помощи революционного манифеста.
    Осторожно, у вас не выйдет завербовать тех, у кого есть имплант "Щит Разума".
    Viva la revolución!
head-rev-briefing =
    Используйте революционный манифест, чтобы конвертировать членов экипажа на свою сторону.
